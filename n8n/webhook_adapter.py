#!/usr/bin/env python3
"""
Standalone Microservice Webhook Adapter for sovereign-spatial-bim
Listens on port 8780 and translates n8n requests into deterministic engine executions.
"""
import sys
import os
import json
...
def run():
    server = HTTPServer(("0.0.0.0", 8780), WebhookHandler)
    print(f"[Sovereign Spatial Bim] Webhook Adapter listening on http://0.0.0.0:8780")
