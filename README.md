...
[![CI](https://github.com/BlackFoxgamingstudio/spatial-bim/actions/workflows/ci.yml/badge.svg)](https://github.com/BlackFoxgamingstudio/spatial-bim/actions/workflows/ci.yml)
...
| **REST Gateway** | ✅ Live on Port `8780` | `POST /api/v1/execute`, `GET /health` |
