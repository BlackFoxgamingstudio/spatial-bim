#!/usr/bin/env python3
"""
CLI entrypoint for sovereign-spatial-bim
"""
import sys
import json
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="High-performance C++/Python 3D model parsing and computational geometry engine. Ingests IFC (BIM architecture), FBX, Collada (DAE), OBJ, executes Clipper polygon booleans, and renders headless F3D GPU previews without commercial CAD licenses.")
